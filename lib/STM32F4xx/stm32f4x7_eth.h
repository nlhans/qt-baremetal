...
/** @defgroup PHY_basic_Control_register 
  * @{
SPECIFIC TO KSZ8051MLL
  */ 
#define PHY_Reset                       ((uint16_t)(1<<15))      /*!< PHY Reset */
#define PHY_Loopback                    ((uint16_t)(1<<14))      /*!< Select loop-back mode */
#define PHY_FULLDUPLEX_100M             ((uint16_t)(1<<13) | (1<<8))      /*!< Set the full-duplex mode at 100 Mb/s */
#define PHY_HALFDUPLEX_100M             ((uint16_t)(1<<13) | (0))      /*!< Set the half-duplex mode at 100 Mb/s */
#define PHY_FULLDUPLEX_10M              ((uint16_t)(0<<13) | (1<<8))      /*!< Set the full-duplex mode at 10 Mb/s */
#define PHY_HALFDUPLEX_10M              ((uint16_t)(0<<13) | (0))      /*!< Set the half-duplex mode at 10 Mb/s */
...
#define PHY_DUPLEX_SPEED_STATUS_MASK    ((uint16_t)(0x7))
#define PHY_100BTX_FULL                 ((uint16_t)(0x6))
#define PHY_100BTX_HALF                 ((uint16_t)(0x5))
#define PHY_10M_FULL                    ((uint16_t)(0x2))
#define PHY_10M_HALF                    ((uint16_t)(0x1))
